#!/usr/bin/env python3
"""MLP on raw windows with per-channel raw normalization (no filtering/features)."""
...
def main():
    ap = argparse.ArgumentParser(description="MLP on raw windows with file-level aggregation")
